...
const Acasa = () => {
  return (
    <section className="text-foreground text-center flex flex-col justify-center items-center w-full pb-10 ">
      ...
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-center md:justify-between items-start md:items-center gap-10 border-b-1 border-x-1 border-foreground/[0.04] text-xl w-full p-10 my-50">
